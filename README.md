...
<body class="bg-gray-50 dark:bg-gray-900 text-gray-800 dark:text-gray-200">
                        ...
                        <div class="card-hover bg-white dark:bg-gray-800 p-6 rounded-xl shadow-lg text-center">
                            ...
                            <div class="text-left space-y-2 mb-4">
                                <p class="text-sm text-gray-600 dark:text-gray-400">
                                    ...
                                    • Choose your age category (elderly/adult/children)<br>
                                    • Specify medical conditions & mobility needs<br>
                                    • Set preferred escort experience level<br>
                                    • Add emergency contact information
                                </p>
                                <p class="text-sm text-gray-600 dark:text-gray-400">
                                    <span class="font-medium">For Escorts:</span><br>
                                    • Share your experience & qualifications<br>
                                    • Set your hourly rates & availability<br>
                                    • Choose volunteer opportunities<br>
                        ...
                        <div class="card-hover bg-white dark:bg-gray-800 p-6 rounded-xl shadow-lg text-center">
                            ...
                            <div class="text-left space-y-2 mb-4">
                                <p class="text-sm text-gray-600 dark:text-gray-400">
                                    ...
                                    • 📍 Location & district proximity<br>
                                    • 🗣️ Language preferences (Cantonese/Mandarin/English)<br>
                                    • 💰 Budget range (Free volunteer to $150/hour)<br>
                                    • ⭐ Experience level & ratings
                                </p>
                                <p class="text-sm text-gray-600 dark:text-gray-400">
                                    <span class="font-medium">Real-time Features:</span><br>
                                    • Live availability status<br>
                                    • Instant booking confirmation<br>
                                    • Emergency escort matching<br>
                                    • Background-checked escorts only
                                </p>
                            </div>
                            <div class="text-center">
                        ...
                        <div class="card-hover bg-white dark:bg-gray-800 p-6 rounded-xl shadow-lg text-center">
                            ...
                            <div class="text-left space-y-2 mb-4">
                                <p class="text-sm text-gray-600 dark:text-gray-400">
                                    ...
                                    • Select date, time & destination<br>
                                    • Choose paid service or free volunteer<br>
                                    • Add special medical requirements<br>
                                    • Secure online payment processing
                                </p>
                                <p class="text-sm text-gray-600 dark:text-gray-400">
                                    <span class="font-medium">Stay Connected:</span><br>
                                    • Real-time booking confirmations<br>
                                    • GPS tracking during escort service<br>
                                    • 24/7 emergency support hotline<br>
                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                                        ...
                                        <div class="bg-gradient-to-r from-primary/10 to-purple-500/10 rounded-lg p-4 mb-4">
                                            <div class="flex items-center space-x-3">
                                                ...
                                                <div class="flex-1">
                                                    ...
                                                    <p class="text-xs text-green-600 dark:text-green-400 mt-1">● Online</p>
                                                </div>
                    ...
                    <div class="mb-4">
                        <button onclick="toggleTracking()" class="bg-primary text-white px-6 py-2 rounded-lg hover:bg-purple-600 transition-colors">
                            📍 Show Active Appointment Tracking
                        </button>
                    </div>
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
                                ...
                                <ul class="text-sm space-y-1">
                                    <li class="text-green-600">✓ Photo uploaded</li>
                                    <li class="text-green-600">✓ Experience added</li>
                                    <li class="text-gray-500">○ Add certifications</li>
                                    <li class="text-gray-500">○ Complete training</li>
                                </ul>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        ...
        function handleAuth(event) {
            ...
            updateAuthUI();
            showDashboard();
            showSuccessMessage(`Welcome to CareConnect, ${userData.firstName}! Your account has been created successfully.`);
        }
        ...
        function updateAuthUI() {
            ...
            if (currentUser) {
                ...
                const roleEmoji = currentUser.userType === 'patient' ? '👤' : '🤝';
                ...
                roleSwitchBtn.innerHTML = `🔄 Switch to ${switchToRole}`;

                // Show/hide undo button based on action history
                if (actionHistory.length > 0) {
                    undoBtn.classList.remove('hidden');
                    undoBtn.textContent = `↶ Undo (${actionHistory.length})`;
                } else {
                ...
                <div class="flex items-start justify-between">
                    <div class="flex items-start space-x-4 flex-1">
                        ...
                        <div class="flex-1">
                            ...
                            <p class="text-sm text-gray-500 mb-1">${escort.experience} • ${escort.completedJobs} jobs completed</p>
                            <p class="text-sm text-gray-500 mb-1">📍 ${escort.district} • Languages: ${escort.languages.join(', ')}</p>
                            <div class="flex items-center justify-between">
                                <div class="flex items-center">
                                    <span class="text-yellow-500">★</span>
                                    <span class="text-sm ml-1">${escort.rating}</span>
                                    <span class="text-sm text-gray-500 ml-3">
                                        ${escort.volunteer ? '🤝 Free/Volunteer + ' : ''}💰 $${escort.hourlyRate}/hour
                                    </span>
                                </div>
                            </div>
                        </div>
            ...
            content.innerHTML = `
                <div class="space-y-4">
                    <div class="flex items-center space-x-3 p-3 border border-gray-200 dark:border-gray-600 rounded-lg">
                        ...
                        <div>
                            <h4 class="font-semibold">${escort.name}</h4>
                            <p class="text-sm text-gray-500">★ ${escort.rating} • ${escort.completedJobs} jobs</p>
                        </div>
                    </div>
        ...
        function confirmBooking(event, escortId) {
            ...
            closeBookingModal();
            showSuccessMessage(`Booking confirmed with ${escort.name}! You'll receive a confirmation email shortly.`);
        }
            ...
            card.innerHTML = `
                <div class="flex items-center justify-between">
                    <div class="flex-1">
                        ...
                        <p class="text-sm text-gray-600 dark:text-gray-400">📅 ${job.date} at ${job.time}</p>
                        <p class="text-sm text-gray-600 dark:text-gray-400">📍 ${job.location}</p>
                        <p class="text-sm font-medium text-green-600 dark:text-green-400">💰 ${job.payment}</p>
                    </div>
        ...
        function confirmEmergencyBooking(event) {
            event.preventDefault();
            closeBookingModal();
            showSuccessMessage('Emergency request submitted! A qualified escort will contact you within 15 minutes. Please keep your phone available.');
        }
        ...
        function createLandingEscortCard(escort) {
            ...
            card.innerHTML = `
                ...
                <div class="space-y-2 mb-4 text-sm">
                    <div class="flex items-center justify-between">
                        <span class="text-gray-600 dark:text-gray-400">📍 District:</span>
                    ...
                    <div class="flex items-center justify-between">
                        <span class="text-gray-600 dark:text-gray-400">🗣️ Languages:</span>
        ...
        function sendQuickMessage(message) {
            ...
            setTimeout(() => {
                addMessageToChat('Acknowledged ✓', 'escort');
            }, 1500);
        }
